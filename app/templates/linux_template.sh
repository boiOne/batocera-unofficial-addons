...
APP_NAME=""  # Insert app name here, e.g., "AssaultCube"
LOGO_URL=""  # Insert the URL for the logo image here
FILE_URL=""  # Insert the download URL (supports .tar.bz2, .tar.gz, .tar.xz, .zip)
LAUNCH_CMD=""  # Insert the launch command/script, e.g., "./assaultcube.sh", "./game", etc.
