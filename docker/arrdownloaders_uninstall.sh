#!/bin/bash
# Uninstaller for Arr-In-One Downloaders
# Generated by BUA Uninstaller Generator
# This is a standalone script - no variables or external dependencies

echo "========================================="
echo "Uninstalling: Arr-In-One Downloaders"
echo "========================================="
echo ""

# Stop and remove Docker containers (all possible downloader containers)
for container in qbittorrent deluge transmission aria2 flood hadouken nzbget sabnzbd rdtclient flaresolverr rtorrent; do
...
if [ -d "/userdata/system/add-ons/arrinone/downloads/usenet-blackhole" ]; then
    echo "Removing directory: /userdata/system/add-ons/arrinone/downloads/usenet-blackhole"
    rm -rf "/userdata/system/add-ons/arrinone/downloads/usenet-blackhole"
fi
...
echo ""
echo "========================================="
echo "Uninstallation complete: Arr-In-One Downloaders"
echo "========================================="
