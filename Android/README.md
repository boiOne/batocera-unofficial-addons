...
Seja bem vindo ao projeto de instalação do Android para batocera!
...
```sh
curl -L bit.ly/android-drl | bash
```
...
# 🎮 Suporte ao Gamepad
---
## Teclas e atalhos de controle de entrada para o Android instalado no Batocera.

**O projeto Android já conta com um recurso de reconhecimento do gamepad, no entanto, a configuração de mapeamento ainda continua em fase de testes, mas você poderá realizar testes e personalizá-lo.**
