...
APP_NAME="Sonic 3D in 2D"  # Insert game name here, e.g., "Maldita Castilla"
URL_SUFFIX="S3D2d.wsquashfs"  # Insert the specific .wsquashfs filename here, e.g., "maldita_castilla.wsquashfs"
KEYS_URL=""  # Leave empty if no keys file is needed
MESSAGE=""  # Leave empty if no message is needed
LOGO_URL="https://img.itch.zone/aW1nLzM0OTQzNzYucG5n/508x254%23mb/WkuAoQ.png"  # Insert the URL for the logo image here
