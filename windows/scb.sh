...
URL="https://github.com/batocera-unofficial-addons/batocera-unofficial-addons/releases/download/AppImages/SuperCrateBox.wsquashfs"
...
LOGO_URL="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/212800/capsule_616x353.jpg"
LOGO_PATH="/userdata/roms/windows/images/scb-logo.jpg"
...
xmlstarlet ed -s "/gameList" -t elem -n "game" -v "" \
  -s "/gameList/game[last()]" -t elem -n "path" -v "./SuperCrateBox.wsquashfs" \
  -s "/gameList/game[last()]" -t elem -n "name" -v "$APP_NAME" \
  -s "/gameList/game[last()]" -t elem -n "image" -v "./images/scb-logo.jpg" \
