...
APP_NAME="Zero-K"  # Insert game name here, e.g., "Maldita Castilla"
URL_SUFFIX="ZeroK.wsquashfs"  # Insert the specific .wsquashfs filename here, e.g., "maldita_castilla.wsquashfs"
KEYS_URL=""  # Leave empty if no keys file is needed
MESSAGE=""  # Leave empty if no message is needed
LOGO_URL="https://media.indiedb.com/images/downloads/1/30/29347/zerok1.jpg"  # Insert the URL for the logo image here
