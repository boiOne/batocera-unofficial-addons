...
APP_NAME="Another Metroid 2 Remake"  # Insert game name here, e.g., "Maldita Castilla"
URL_SUFFIX="AM2R.wsquashfs"  # Insert the specific .wsquashfs filename here, e.g., "maldita_castilla.wsquashfs"
KEYS_URL=""  # Leave empty if no keys file is needed
MESSAGE=""  # Leave empty if no message is needed
LOGO_URL="https://cdn2.steamgriddb.com/thumb/e4343ac10dbaada982a3108b5ae6315f.png"  # Insert the URL for the logo image here
