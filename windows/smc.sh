...
APP_NAME="Secret Maryo Chronicles"  # Insert game name here, e.g., "Maldita Castilla"
URL_SUFFIX="SMC.wsquashfs"  # Insert the specific .wsquashfs filename here, e.g., "maldita_castilla.wsquashfs"
KEYS_URL=""  # Leave empty if no keys file is needed
MESSAGE=""  # Leave empty if no message is needed
LOGO_URL="https://raw.githubusercontent.com/MrStahlfelge/SMC-libgdx/master/_market/Screenshot_2017-11-01-19-36-52.png"  # Insert the URL for the logo image here
