...
URL="https://github.com/batocera-unofficial-addons/batocera-unofficial-addons/releases/download/AppImages/sorr.wsquashfs"
...
APP_NAME="Streets of Rage Remake"
LOGO_URL="https://cdn2.steamgriddb.com/thumb/091aff76cd0d6c92fa7d47613ae88827.jpg"
LOGO_PATH="/userdata/roms/windows/images/sorr-logo.jpg"
...
xmlstarlet ed -s "/gameList" -t elem -n "game" -v "" \
  -s "/gameList/game[last()]" -t elem -n "path" -v "./sorr.wsquashfs" \
  -s "/gameList/game[last()]" -t elem -n "name" -v "$APP_NAME" \
  -s "/gameList/game[last()]" -t elem -n "image" -v "./images/sorr-logo.jpg" \
