...
APP_NAME="SHRUBNAUT"  # Insert game name here, e.g., "Maldita Castilla"
URL_SUFFIX="SHRUBNAUT.wsquashfs"  # Insert the specific .wsquashfs filename here, e.g., "maldita_castilla.wsquashfs"
KEYS_URL=""  # Leave empty if no keys file is needed
MESSAGE=""  # Leave empty if no message is needed
LOGO_URL="https://img.itch.zone/aW1hZ2UvNjczODEvMzE4ODcxLnBuZw==/original/xEN0vN.png"  # Insert the URL for the logo image here
